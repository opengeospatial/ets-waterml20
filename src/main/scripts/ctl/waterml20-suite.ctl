...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl"
  ...
  xmlns:tns="http://www.opengis.net/cite/waterml20"
  xmlns:saxon="http://saxon.sf.net/"
  xmlns:tec="java:com.occamlab.te.TECore"
  xmlns:tng="java:org.opengis.cite.waterml20.TestNGController">

  <ctl:function name="tns:run-ets-waterml20">
    ...
    <ctl:param name="outputDir">The directory in which the test results will be written.</ctl:param>
		...
		<ctl:description>Runs the waterml20 ${version} test suite.</ctl:description>
    <ctl:code>
   ...
   <ctl:suite name="tns:ets-waterml20-${version}">
     <ctl:title>WaterML 2.0 Executable Test Suite</ctl:title>
	  ...
	  <ctl:code>
        <xsl:variable name="form-data">
           <ctl:form method="POST" width="800" height="600" xmlns="http://www.w3.org/1999/xhtml">
             <h2>WaterML 2.0 Executable Test Suite</h2>
       ...
       <xsl:variable name="test-results">
        <ctl:call-function name="tns:run-ets-waterml20">
