package org.opengis.cite.waterml20.level1;

import java.io.IOException;
import java.net.URL;
import javax.xml.transform.Source;
import javax.xml.transform.dom.DOMSource;
import org.opengis.cite.waterml20.ErrorMessage;
import org.opengis.cite.waterml20.ErrorMessageKeys;
import org.opengis.cite.waterml20.SuiteAttribute;
...
public class Capability1Tests {
     ...
     * {@link org.opengis.cite.waterml20.SuiteAttribute#TEST_SUBJECT} should
    ...
    public void docIsValidAtomFeed() throws SAXException, IOException {
        URL schemaRef = getClass().getResource(
                "/org/opengis/cite/waterml20/rnc/atom.rnc");
